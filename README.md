...
### If you'd like to take a look at the examples codes used in this project, please refer to notebooks/sample_notebooks.
...
* **Data Analysis and Manipulation:** Pandas, NumPy, Polars
...
## Project Structure
    ...
    │   └── sample_notebooks/                         # Selected notebooks for the viewers
    └── tabnet/                                       # Notebooks for TabNet experiments

---

## Acknowledgements

Thanks to the **Child Mind Institute** and **Kaggle** for providing the dataset and an opportunity to participate in such an interesting competition.

This project was helped by the following open source resources: Python, LightGBM, XGBoost, CatBoost, Optuna, SHAP, scikit-learn, pandas, numpy, matplotlib, seaborn, Jupyter, Polars, SciPy.
